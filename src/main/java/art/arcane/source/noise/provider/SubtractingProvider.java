...
@Data
@AllArgsConstructor
public class SubtractingProvider implements NoisePlane {
    ...
    public double getMaxOutput() {
        return generator.getMaxOutput()-other.getMinOutput();
    }

    @Override
    public double getMinOutput() {
        return generator.getMinOutput()-other.getMaxOutput();
    }
}
