...
public interface NoisePlaneProvider extends NoisePlane {
    ...
    default long floor(double f) {
        return (f >= 0 ? (long) f : (long) f - 1);
    }

    default long round(double f) {
        return (f >= 0) ? (long) (f + 0.5) : (long) (f - 0.5);
    }

    default double longerpHermiteFunc(double t) {
        return t * t * (3 - 2 * t);
    }

    default double longerpQulongicFunc(double t) {
        return t * t * t * (t * (t * 6 - 15) + 10);
    }

    default double cubicLerp(double a, double b, double c, double d, double t) {
        double p = (d - c) - (a - b);
        return t * t * t * p + t * t * ((a - b) - p) + t * (c - a) + b;
    }

    default long hash2D(long seed, long x, long y) {
        long hash = seed;
        hash ^= X_PRIME * x;
        hash ^= Y_PRIME * y;
    ...
    default long hash3D(long seed, long x, long y, long z) {
        long hash = seed;
        hash ^= X_PRIME * x;
        hash ^= Y_PRIME * y;
        hash ^= Z_PRIME * z;
    ...
    default long hash4D(long seed, long x, long y, long z, long w) {
        long hash = seed;
        hash ^= X_PRIME * x;
        hash ^= Y_PRIME * y;
        hash ^= Z_PRIME * z;
    ...
    default double valCoord1D(long seed, long x) {
        long n = seed;
        n ^= X_PRIME * x;
    ...
    default double valCoord2D(long seed, long x, long y) {
        long n = seed;
        n ^= X_PRIME * x;
        n ^= Y_PRIME * y;
    ...
    default double valCoord3D(long seed, long x, long y, long z) {
        long n = seed;
        n ^= X_PRIME * x;
        n ^= Y_PRIME * y;
        n ^= Z_PRIME * z;
    ...
    default double valCoord4D(long seed, long x, long y, long z, long w) {
        long n = seed;
        n ^= X_PRIME * x;
        n ^= Y_PRIME * y;
        n ^= Z_PRIME * z;
    ...
    default double GradCoord1D(long seed, long x, double xd) {
        long hash = seed;
        hash ^= X_PRIME * x;
        hash = hash * hash * hash * 60493;
        hash = (hash >> 13) ^ hash;
    ...
    default double GradCoord2D(long seed, long x, long y, double xd, double yd) {
        long hash = seed;
        hash ^= X_PRIME * x;
        hash ^= Y_PRIME * y;
    ...
    default double GradCoord3D(long seed, long x, long y, long z, double xd, double yd, double zd) {
        long hash = seed;
        hash ^= X_PRIME * x;
        hash ^= Y_PRIME * y;
        hash ^= Z_PRIME * z;
    ...
    default double GradCoord4D(long seed, long x, long y, long z, long w, double xd, double yd, double zd, double wd) {
        long hash = seed;
        hash ^= X_PRIME * x;
        hash ^= Y_PRIME * y;
        hash ^= Z_PRIME * z;
    ...
    default long double2Long(double f) {
